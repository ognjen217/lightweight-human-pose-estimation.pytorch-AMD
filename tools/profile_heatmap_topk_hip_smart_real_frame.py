...
def parse_args():
    ...
    p.add_argument("--json", default="outputs/split_pipeline_compare/b4_hip_smart_stage_profile_r3.json")
    p.add_argument("--markdown", default="outputs/split_pipeline_compare/b4_hip_smart_stage_profile_r3.md")
    return p.parse_args()
