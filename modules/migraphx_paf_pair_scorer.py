#!/usr/bin/env python3
"""Runtime wrapper for compiled MIGraphX PAF pair scorer."""
...
class MIGraphXPAFPairScorer:
    ...
    def run(self, top_scores, top_indices, pafs_nchw) -> Tuple[np.ndarray, np.ndarray]:
        ...
        # The ONNX/MXR scorer intentionally expects flattened indices as float32
        # to avoid depending on int64 arithmetic support inside MIGraphX.
